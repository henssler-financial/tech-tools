...
- orc-explorer: locate the relevant components, tokens, and routes.
- frontend-developer: build or refactor the screens and components.
- orc-ui-runtime-tester: confirm observed behavior in a real browser.
- orc-verifier: independently confirm the claims hold.
