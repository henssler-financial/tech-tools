...
- orc-explorer: locate the component library, tokens, and any sibling components to mirror.
- frontend-developer: define the contract, then implement the component.
- orc-ui-runtime-tester: drive a harness page and confirm each state renders.
- orc-verifier: independently confirm the contract and states hold.
