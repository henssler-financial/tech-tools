...
- orc-explorer: map where the new endpoints, models, and UI belong.
- backend-architect or orc-implementer: add the API surface, services, and data access.
- frontend-developer: build the UI against the new endpoints.
- orc-verifier: independently confirm each claim.
- orc-ui-runtime-tester: confirm live UI behavior in the browser.
