...
def main():
    ...
    lines = [
        ...
        "Memory (claude-mem): " + ("available" if mem else "absent - run /atlas to install for self-improvement") + ".",
        "Context protection (context-mode): " + ("available" if ctx else "absent - run /atlas to install for large-output work") + ".",
    ]
    out = {
        "additionalContext": "\n".join(lines)[:9000],
