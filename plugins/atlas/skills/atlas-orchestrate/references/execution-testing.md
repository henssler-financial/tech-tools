...
5. **Capture** screenshots + console + network into `.atlas/evidence/`. Tear down the server.
...
5. Use `whodb`/data-agent-kit plugins or `gcloud` if present and helpful. Capture plans into `.atlas/evidence/`.
